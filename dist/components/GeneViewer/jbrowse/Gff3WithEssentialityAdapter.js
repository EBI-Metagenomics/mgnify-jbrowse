...
const Gff3Adapter_1 = __importDefault(require("@jbrowse/plugin-gff3/esm/Gff3Adapter/Gff3Adapter"));
const configSchema_1 = __importDefault(require("@jbrowse/plugin-gff3/esm/Gff3Adapter/configSchema"));
...
exports.configSchema = (0, configuration_1.ConfigurationSchema)('Gff3WithEssentialityAdapter', {
    essentialityCsvUrl: {
        type: 'string',
        defaultValue: '',
