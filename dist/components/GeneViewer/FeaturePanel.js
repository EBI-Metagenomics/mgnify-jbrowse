...
function Field(props) {
    return ((0, jsx_runtime_1.jsxs)("div", { style: { marginBottom: 10 }, children: [(0, jsx_runtime_1.jsx)("div", { style: { fontSize: 11, color: '#6b7280', marginBottom: 2 }, children: props.label }), (0, jsx_runtime_1.jsx)("div", { style: { fontSize: 13, wordBreak: 'break-word' }, children: props.children })] }));
}
function FeaturePanel(props) {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    const f = props.feature;
    if (!f) {
        return ((0, jsx_runtime_1.jsx)("div", { style: { padding: 12, color: '#6b7280', fontSize: 13 }, children: "Select a gene to see details." }));
    }
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: { padding: 12 }, children: [(0, jsx_runtime_1.jsx)("div", { style: { fontWeight: 800, marginBottom: 10 }, children: "Feature Details" }), (0, jsx_runtime_1.jsx)(Field, { label: "Locus Tag", children: locusTag }), (0, jsx_runtime_1.jsx)(Field, { label: "Name", children: name }), (0, jsx_runtime_1.jsx)(Field, { label: "Product", children: product }), (0, jsx_runtime_1.jsx)(Field, { label: "Type", children: f.type }), (0, jsx_runtime_1.jsxs)(Field, { label: "Location", children: [f.refName, ":", f.start + 1, "..", f.end, " (", f.strand === 1 ? '+' : f.strand === -1 ? '-' : '.', ")"] }), props.essentiality ? ((0, jsx_runtime_1.jsx)(Field, { label: "Essentiality Status", children: (0, jsx_runtime_1.jsxs)("span", { style: { display: 'inline-flex', alignItems: 'center', gap: 8 }, children: [(0, jsx_runtime_1.jsx)("span", { style: {
                            ...
                            } }), (0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", children: props.essentiality.icon }), (0, jsx_runtime_1.jsx)("span", { style: { fontWeight: 600 }, children: props.essentiality.status })] }) })) : null, (0, jsx_runtime_1.jsx)("div", { style: { marginTop: 14, fontWeight: 700, marginBottom: 6, fontSize: 12 }, children: "Attributes" }), (0, jsx_runtime_1.jsx)("div", { style: { maxHeight: 280, overflow: 'auto', border: '1px solid #e5e7eb', borderRadius: 6 }, children: (0, jsx_runtime_1.jsx)("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: 12 }, children: (0, jsx_runtime_1.jsx)("tbody", { children: Object.entries(attrs).map(([k, v]) => ((0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("td", { style: { padding: '6px 8px', borderBottom: '1px solid #f3f4f6', width: 120, color: '#374151' }, children: k }), (0, jsx_runtime_1.jsx)("td", { style: { padding: '6px 8px', borderBottom: '1px solid #f3f4f6', color: '#111827' }, children: v || '—' })] }, k))) }) }) })] }));
}
