...
export function useGeneViewerZoom(viewState, props, initialZoomAppliedRef) {
    useEffect(() => {
        var _a, _b;
        ...
        const apply = () => {
            ...
            try {
                ...
                const visibleBp = (_b = props.initialVisibleBp) !== null && _b !== void 0 ? _b : DEFAULT_INITIAL_VISIBLE_BP;
