export const DEFAULT_ESSENTIALITY_COLOR_MAP = {
    essential: '#FF0000',
...
export function normalizeEssentialityStatus(input) {
...
export function getColorForEssentiality(status, colorMap) {
    var _a, _b;
    const map = { ...DEFAULT_ESSENTIALITY_COLOR_MAP, ...(colorMap !== null && colorMap !== void 0 ? colorMap : {}) };
    return (_b = (_a = map[status]) !== null && _a !== void 0 ? _a : map.unknown) !== null && _b !== void 0 ? _b : DEFAULT_ESSENTIALITY_COLOR_MAP.unknown;
}
export function getIconForEssentiality(status) {
    switch (status) {
        case 'essential':
            return '🧪🧫';
        case 'essential_liquid':
...
export function buildEssentialityIndexFromCsv(csvText, opts) {
    var _a, _b, _c, _d, _e;
